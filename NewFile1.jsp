...
.zoom:hover {
 ...
 <section class="section2">
  ...
  try {
		...
		String sql="SELECT * FROM `orders` WHERE status ='1' or status='2' or status='3'";
...
%>
   ...
   <tr>
    ...
    <th><%=rs.getString("orddate")%></th>
     <th><a href=processOrder.jsp?isbn=<%=rs.getString("ordid")%>?status=<%=rs.getString("status")%>>Process Order </a> </th>
    </tr>
