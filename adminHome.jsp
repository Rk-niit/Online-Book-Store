<jsp:useBean id="order"  scope="session"  class="obs.Cart"/>
...
.zoom:hover {
 ...
 <section class="section2">
  ...
  <div style="background-color:white">
          <%
int newOrder=order.returnNewOrders();
int processOrder=order.returnProcessOrders();
int dispatchOrder=order.returnDispatchOrders();
int completeOrder=order.returnCompleteOrders();
%>
<div id="piechart"></div>
...
var x=<% out.print(newOrder); %>
var y=<% out.println(processOrder); %>
var z=<% out.println(dispatchOrder); %>
var w=<% out.println(completeOrder); %>
// Load google charts
...
function drawChart() {
  ...
  var options = {'title':'Orders', 'width':1000, 'height':600};
