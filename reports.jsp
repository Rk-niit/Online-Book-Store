...
<section class="section2">
  ...
  <div style="background-color:white">
        <table style="width:100%" class="mySlides">
        <div align="center">
...
if(opt.equals("1")){
	...
	try {
        ...
        String sql="SELECT * FROM `users` WHERE `Created_date` BETWEEN '"+date1+"' AND '"+date2+"' ";
...
<tr>
   <th><%=rs.getInt("id")%></th>
    ...
    <th><%=rs.getInt("phone")%></th>
    <th><%=rs.getString("Created_date")%></th>
    </tr>
    <%
	...
	try {
        ...
        String pass="";
        Connection con=DriverManager.getConnection(url,usr,pass);
        String sql="SELECT * FROM `books` WHERE `Created_date` BETWEEN '"+date1+"' AND '"+date2+"' ";
        PreparedStatement ps=con.prepareStatement(sql);
...
<%
	...
	try {
        ...
        String pass="";
        Connection con=DriverManager.getConnection(url,usr,pass);
        String sql="SELECT * FROM `orders` WHERE `orddate` BETWEEN '"+date1+"' AND '"+date2+"' ";
        PreparedStatement ps=con.prepareStatement(sql);
